...
def VocabPage.helper(bilingual,context,genos,db,wikt,core,treebank,freq,notes,vocab_by_chapter,start_chapter,ch,if_warn:true,reduce_max_entries:0)
  # Doesn't get called if if_prose_trial_run is set.
  vl = Vlist.from_text(bilingual.foreign_text,context,treebank,freq,genos,db,wikt,core:core,if_warn:if_warn,reduce_max_entries:reduce_max_entries, \
