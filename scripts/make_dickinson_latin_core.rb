# original CSV file is from https://dcc.dickinson.edu/latin-core-list1
# cc-by-sa licensed
...
def main
  csv = CSV.new(dickinson_original_csv())

  glosses = {}
  csv.each { |row|
    latin,gloss,pos,category,freq_rank = row
    latin = remove_macrons_and_breves(latin)
    latin.gsub!(/\s+.*/,'') # e.g., in "aes aeris n.", remove everything but the lemma "aes"
    g = [gloss]
    glosses[latin] = g
  }

  print (<<-'COMMENT'
// This file is generated by doing a 'make latin_core'. Don't edit it by hand
COMMENT
  )+ JSON.pretty_generate(glosses)+"\n"
end

def dickinson_original_csv
...
ac,"and in addition, and also, and; (after comparatives) than; simul ac, as soon as; → atque",Conjunction,Conjunctions/Adverbs,36
...
"accipiō -cipere -cēpī -ceptum",receive,"Verb: 3rd Conjugation -iō","Social Life",110
...
"agō agere ēgī āctum","drive, do, act","Verb: 3rd Conjugation -ō","Verbs of Compelling/Directing",69
...
"alius -a -ud","other, another; ālias: at another time","Adjective: 1st and 2nd Declension",Pronouns/Interrogatives,37
...
"amor -ōris m.",love,"Noun: 3rd Declension",Love,116
...
"animus -ī m.","spirit, mind","Noun: 2nd Declension","Life and Being",40
...
"arma -ōrum n. pl.","arms, weapons","Noun: 2nd Declension","War and Peace",98
...
atque,"and in addition, and also, and; (after comparatives) than; simul atque, as soon as; → ac",Conjunction,Conjunctions/Adverbs,35
...
"audiō -īre -īvī/-iī -ītum","hear, listen to","Verb: 4th Conjugation","Other Senses",165
...
"bellum -ī n.",war,"Noun: 2nd Declension","War and Peace",86
...
"caelum -ī n.","sky, heavens","Noun: 2nd Declension","Air and Fire",117
...
"capiō capere cēpī captum",seize,"Verb: 3rd Conjugation -iō","War and Peace",131
...
"crēdō crēdere crēdidī crēditum",believe,"Verb: 3rd Conjugation -ō",Education/Knowledge,109
...
dē,"down from, about, concerning (+ abl.)",Preposition,Place,46
"dēbeō dēbēre dēbuī dēbitum","owe, be obliged","Verb: 2nd Conjugation",Business/Money,155
...
deinde/dein,"then, next",Adverb,Time,150
...
"deus -ī m.; dea -ae f.","god; goddess","Noun: 2nd Declension",Religion,42
"dexter -tra -trum","right; dextera -ae f.: right hand","Adjective: 1st and 2nd Declension",Place,260
"dīcō dīcere dīxī dictum","say; causam dīcere, plead a case; diem dīcere, appoint a day","Verb: 3rd Conjugation -ō",Speech/Oratory,33
"diēs diēī m./f.",day,"Noun: 5th Declension","Lengths of Time",54
...
"domus -ūs f.","house, home","Noun: 4th Declension","The House",73
...
"dūcō dūcere dūxī ductum","lead; uxōrem dūcere, marry","Verb: 3rd Conjugation -ō","Verbs of Compelling/Directing",133
...
"ego meī mihi mē","I, me",Pronoun,Pronouns/Interrogatives,11
...
"eō īre iī/īvī itum",go,"Verb: Irregular",Motion,97
...
ergō,therefore,Conjunction,Conjunctions/Adverbs,134
...
etiam,"also, even",Adverb,Conjunctions/Adverbs,67
"ex, ē","out of, from (+ abl.)",Preposition,Place,26
...
"faciō facere fēcī factum","do, make","Verb: 3rd Conjugation -iō",Making/Doing,32
...
"fātum -ī n.","fate; death","Noun: 2nd Declension",Religion,157
...
"ferō ferre tulī lātum","bear, carry, endure","Verb: Irregular","Verbs of Transport",45
...
"fīō fierī factus sum","become, happen, be done","Verb: Irregular","Life and Being",146
...
iam,"now; already",Adverb,Time,34
ibi,there,Adverb,Place,619
"īctus -ūs m.","blow, stroke","Noun: 4th Declension",Violence,819
"īdem eadem idem","the same",Pronoun,Pronouns/Interrogatives,59
...
"inquam, inquis, inquit, inquiunt:","say (used with direct speech)","Verb: Irregular",Speech/Oratory,163
...
"iste ista istud","that, that of yours; adv. istīc or istūc: over there; istinc: from over there",Pronoun,Pronouns/Interrogatives,81
ita,"thus, so",Adverb,Conjunctions/Adverbs,120
...
"iubeō iubēre iussī iussum","bid, order","Verb: 2nd Conjugation",Justice,84
...
"locus -ī m.","place; loca (n. pl.) region","Noun: 2nd Declension",Geography,62
...
magis,more,Adverb,Conjunctions/Adverbs,90
...
"māgnus -a -um",great,"Adjective: 1st and 2nd Declension",Measurement,25
...
"manus -ūs f.","hand; band of men","Noun: 4th Declension","The Body",48
"mare -is n.",sea,"Noun: 3rd Declension","Earth and Water",125
"marītus -ī m.",husband,"Noun: 2nd Declension","The Household",654
"māter mātris f.",mother,"Noun: 3rd Declension","The Household",127
...
"mīles -itis m.",soldier,"Noun: 3rd Declension","War and Peace",161
...
"mittō mittere mīsī missum","send, let go","Verb: 3rd Conjugation -ō","Verbs of Compelling/Directing",114
modo,"just, just now; modo ... modo: now ... now, at one moment ... at another, sometimes ... sometimes",Adverb,Time,152
...
"multus -a -um","much, many; multō, by far","Adjective: 1st and 2nd Declension",Measurement,43
...
nē,"lest, that not",Conjunction,Conjunctions/Adverbs,47
nec,"and not, nor; nec ... nec, neither ... nor; → neque",Conjunction,Conjunctions/Adverbs,19
...
neque,"and not, nor; neque ... neque, neither ... nor; → nec",Conjunction,Conjunctions/Adverbs,72
"nesciō -scīre","not know, be ignorant","Verb: 4th Conjugation",Education/Knowledge,525
"nisi, nī","if not, unless",Conjunction,Conjunctions/Adverbs,100
"niger nigra nigrum",black,"Adjective: 1st and 2nd Declension",Vision,634
"nihil, nīl","nothing; not at all","Noun: Indeclinable",Measurement,55
...
"nōmen -inis n.",name,"Noun: 3rd Declension","Social Life",135
nōn,not,Adverb,Conjunctions/Adverbs,6
nōndum,"not yet",Adverb,Conjunctions/Adverbs,436
"nōs nostrum/nostrī nōbīs nōs",we,Pronoun,Pronouns/Interrogatives,51
...
"nūllus -a -um","not any, no one","Adjective: 1st and 2nd Declension",Pronouns/Interrogatives,49
...
"ōs ōris n.","mouth, face","Noun: 3rd Declension","The Body",147
...
"petō petere petīvī petītum","seek, aim at","Verb: 3rd Conjugation -ō",Motion,83
...
"pōnō pōnere posuī positum","put, place; put aside","Verb: 3rd Conjugation -ō","Verbs of Transport",102
"pontus -ī m.","the open sea, the deep","Noun: 2nd Declension","Earth and Water",630
"populus -ī m.",people,"Noun: 2nd Declension","The City",122
...
"possum posse potuī","be able","Verb: Irregular",Making/Doing,23
...
"prīmus -a -um",first,"Adjective: 1st and 2nd Declension",Time,91
...
prō,"for, on behalf of, in proportion to (+abl.)",Preposition,"Non-Directional Prepositions",128
...
"quaerō -rere -sīvī -sītum","seek, inquire","Verb: 3rd Conjugation -ō",Education/Knowledge,113
"quālis -e","of what kind? what?",Pronoun,Pronouns/Interrogatives,263
quam,"how?; (after comparative) than",Adverb,Pronouns/Interrogatives,29
...
"quī quae quod","who, which, what",Pronoun,Pronouns/Interrogatives,3
...
"quīdam quaedam quoddam","a certain one, someone",Pronoun,Pronouns/Interrogatives,126
quidem,"certainly, at least",Adverb,Conjunctions/Adverbs,136
...
"rēgnum -ī n.","kingship, kingdom","Noun: 2nd Declension",Geography,121
"regō regere rēxī rēctum","guide, rule","Verb: 3rd Conjugation -ō","The City",554
"relinquō -linquere -līquī -lictum",abandon,"Verb: 3rd Conjugation -ō",Motion,144
...
"rēs reī f.","thing (rēs pūblica, commonwealth; rēs familiāris, family property, estate; rēs mīlitāris, art of war; rēs novae, revolution)","Noun: 5th Declension","Life and Being",38
...
"rēx rēgis m.",king,"Noun: 3rd Declension","The City",60
...
semper,"always, ever",Adverb,Time,149
...
"sequor sequī secūtus sum",follow,"Verb: Deponent",Motion,108
...
sī,if,Conjunction,Conjunctions/Adverbs,16
sīc,"in this manner, thus; sīc ... ut: in the same way as",Adverb,Conjunctions/Adverbs,79
...
"sui sibi sē/sēsē","him- her- itself, themselves",Pronoun,Pronouns/Interrogatives,17
"sum esse fuī futūrum","be, exist; fut. infin. often = fore, impf. subj. often = forem for essem","Verb: Irregular","Life and Being",2
...
tam,"so, so much",Adverb,Conjunctions/Adverbs,96
...
"tantus -a -um","so great, so much; (as pronoun) such a quantity, so much; tantī, at such a price, of such worth","Adjective: 1st and 2nd Declension",Measurement,105
...
"teneō -ēre -uī tentum","hold, keep","Verb: 2nd Conjugation","Other Senses",106
...
"timeō -ēre -uī","to fear, to dread","Verb: 2nd Conjugation",Emotions,153
...
"tōtus -a -um","whole, entire","Adjective: 1st and 2nd Declension",Measurement,78
...
"tū tuī tibi tē","you (sing.)",Pronoun,Pronouns/Interrogatives,9
"tum or tunc",then,Adverb,Time,56
...
ubi,"where, when",Adverb,Place,92
...
vel,"or else, or; even; vel ... vel: either … or",Conjunction,Conjunctions/Adverbs,141
velut,"even as, just as",Adverb,Conjunctions/Adverbs,447
"veniō venīre vēnī ventum",come,"Verb: 4th Conjugation",Motion,63
...
"videō vidēre vīdī vīsum",see,"Verb: 2nd Conjugation",Vision,31
"vincō vincere vīcī victum",conquer,"Verb: 3rd Conjugation -ō","War and Peace",101
...
"vir virī m.",man,"Noun: 2nd Declension",People,85
"virgō -inis f.","maiden, virgin, girl","Noun: 3rd Declension",People,418
"virtūs -ūtis f.","valor, manliness, virtue","Noun: 3rd Declension","Personality Traits/Characteristics",111
"vīs f.","force; (acc.) vim, (abl.) vī; (pl.) vīrēs, strength","Noun: 3rd Declension","War and Peace",115
...
"vīvō vīvere vīxī vīctum",live,"Verb: 3rd Conjugation -ō","Life and Being",156
...
"ūnus -a -um",one,"Adjective: 1st and 2nd Declension",Measurement,53
"vocō -āre",call,"Verb: 1st Conjugation",Speech/Oratory,158
"volō velle voluī","wish, be willing","Verb: Irregular",Emotions,66
...
vōs,"you (pl.); (gen.) vestrum/vestrī, (dat./abl.) vōbīs, (acc.) vōs","Adjective: 1st and 2nd Declension",Pronouns/Interrogatives,130
...
"ut, utī","as (+ indic.); so that, with the result that (+ subj.); (in questions) in what manner, how; (exclam.) to what an extent! how!",Adverb,Conjunctions/Adverbs,15
