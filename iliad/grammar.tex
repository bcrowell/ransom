...
\textbf{imperative}\\
active                       &  \multicolumn{3}{l}{pres.~ε/θι/τι\footnotemark[7], aor.~ον}   & \multicolumn{3}{l}{pres.~ετε, aor.~ατε }      \\
...
\footnotetext[7]{θι is omitted in present, and becomes τι after another aspirated consonant}
