...
@@notes = [
  ...
  ["4.383" , {
    'about_what'    => %q{Ἀσωπός},
    'explain'       => %q{a river, the border between Thebes and Plataea}
  }],
  ["4.384" , {
    'about_what'    => %q{ἀγγελίην ἐπὶ Τυδῆ στεῖλαν Ἀχαιοί},
    'explain'       => %q{The Achaeans send a message through Tydeus, not to him.}
  }],
  ["4.387" , {
